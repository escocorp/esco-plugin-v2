...
object DiscordCommandAnnotationProcessor {
    fun registerCommands(
        ...
        globalCommandListener: CommandHandler,
    ) {
        for (function in listener::class.memberFunctions) {
            ...
            val handler =
                CommandHandler.CommandRunner { args: Array<String>, ctx: Context ->
                    ...
                    try {
                        ...
                        val contextParam =
                            function.parameters.find { it.type.jvmErasure == Context::class }
